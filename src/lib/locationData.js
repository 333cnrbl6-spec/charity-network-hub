...
// Data sources: ONS, Age UK, Local Authority profiles
...
export const LOCATION_CONFIGS = {
  ...
  stockport: {
    ...
    services: [
      ...
      { service_name: 'Community Bus Service', service_type: 'transport', delivery_method: 'Scheduled routes', target_group: 'General public 60+', capacity: 250 },
      ...
      { service_name: 'Pension Advice Service', service_type: 'benefits-advice', delivery_method: 'Drop-in & appointments', target_group: 'Low-income pensioners', capacity: 80 }
    ],
    staff_roles: [
...
export const getLocationConfig = (branchId) => {
  return LOCATION_CONFIGS[branchId] || null;
};

export const getAllLocationConfigs = () => {
  return Object.values(LOCATION_CONFIGS);
};