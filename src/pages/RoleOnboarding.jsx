...
import AIDataClassifier from '@/components/onboarding/AIDataClassifier';
          ...
          <div className="space-y-4">
            ...
            <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-amber-700 mt-0.5">Your portal has sample data for demonstration. In the next steps you'll import your real data — the demo data will be replaced automatically.</p>
              </div>
            </div>
